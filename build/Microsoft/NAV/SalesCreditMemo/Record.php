...
use Microsoft\NAV\CustomerReturnReason;
...
class Record extends Entity
{
    public function __construct(array $data = [], protected ?string $context = null)
    {
        ...
        $this->classMap = [
            ...
            Properties::salesCreditMemoLines->name => SalesCreditMemoLine\Record::class,
    ...
    public function getStatus(): ?Enums\SalesCrMemoEntityBufferStatus
    {
        return $this->getAsEnum(Properties::status->name, Enums\SalesCrMemoEntityBufferStatus::class);
    }

    public function setStatus(?Enums\SalesCrMemoEntityBufferStatus $value): self
    {
    ...
    {
        return $this->get(Properties::customerReturnReasonId->name);
    }

    public function setCustomerReturnReasonId(?string $value): self
    {
        $this->set(Properties::customerReturnReasonId->name, $value);
        return $this;
    }
    ...
    {
        return $this->get(Properties::salesCreditMemoLines->name) ?? new Entity\Collection();
    }
