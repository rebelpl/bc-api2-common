...
class Record extends Entity
{
    public function __construct(array $data = [], protected ?string $context = null)
    {
        ...
        $this->classMap = [
            ...
            Properties::salesQuoteLines->name => SalesQuoteLine\Record::class,
    ...
    {
        return $this->getAsDate(Properties::documentDate->name);
    }

    public function setDocumentDate(?\DateTime $value): self
    {
        $this->set(Properties::documentDate->name, $value);
        return $this;
    }
    ...
    public function getStatus(): ?Enums\SalesQuoteEntityBufferStatus
    {
        return $this->getAsEnum(Properties::status->name, Enums\SalesQuoteEntityBufferStatus::class);
    }

    public function setStatus(?Enums\SalesQuoteEntityBufferStatus $value): self
    {
    ...
    {
        return $this->getAsDateTime(Properties::sentDate->name);
    }

    public function setSentDate(?\DateTime $value): self
    {
        $this->set(Properties::sentDate->name, $value);
        return $this;
    }

    public function getValidUntilDate(): ?\DateTime
    {
        return $this->getAsDate(Properties::validUntilDate->name);
    }

    public function setValidUntilDate(?\DateTime $value): self
    {
        $this->set(Properties::validUntilDate->name, $value);
        return $this;
    }

    public function getAcceptedDate(): ?\DateTime
    {
        return $this->getAsDate(Properties::acceptedDate->name);
    }

    public function setAcceptedDate(?\DateTime $value): self
    {
        $this->set(Properties::acceptedDate->name, $value);
        return $this;
    }
    ...
    {
        return $this->get(Properties::salesQuoteLines->name) ?? new Entity\Collection();
    }
