...
class Record extends Entity
{
    public function __construct(array $data = [], protected ?string $context = null)
    {
        ...
        $this->classMap = [
            ...
            Properties::purchaseInvoiceLines->name => PurchaseInvoiceLine\Record::class,
    ...
    {
        return $this->get(Properties::vendorInvoiceNumber->name);
    }

    public function setVendorInvoiceNumber(?string $value): self
    {
        $this->set(Properties::vendorInvoiceNumber->name, $value);
        return $this;
    }
    ...
    {
        return $this->get(Properties::purchaseInvoiceLines->name) ?? new Entity\Collection();
    }
