...
class Record extends Entity
{
    public function __construct(array $data = [], protected ?string $context = null)
    {
        ...
        $this->classMap = [
            ...
            Properties::salesInvoiceLines->name => SalesInvoiceLine\Record::class,
    ...
    public function getPromisedPayDate(): ?\DateTime
    {
        return $this->getAsDate(Properties::promisedPayDate->name);
    }

    public function setPromisedPayDate(?\DateTime $value): self
    {
        $this->set(Properties::promisedPayDate->name, $value);
        return $this;
    }
    ...
    {
        return $this->get(Properties::orderId->name);
    }

    public function setOrderId(?string $value): self
    {
        $this->set(Properties::orderId->name, $value);
        return $this;
    }
    ...
    public function getDisputeStatusId(): ?string
    {
        return $this->get(Properties::disputeStatusId->name);
    }

    public function setDisputeStatusId(?string $value): self
    {
        $this->set(Properties::disputeStatusId->name, $value);
        return $this;
    }

    public function getDisputeStatus(): ?string
    {
        return $this->get(Properties::disputeStatus->name);
    }

    public function setDisputeStatus(?string $value): self
    {
        $this->set(Properties::disputeStatus->name, $value);
        return $this;
    }
    ...
    public function getStatus(): ?Enums\InvoiceEntityAggregateStatus
    {
        return $this->getAsEnum(Properties::status->name, Enums\InvoiceEntityAggregateStatus::class);
    }

    public function setStatus(?Enums\InvoiceEntityAggregateStatus $value): self
    {
     ...
     */
    public function getSalesInvoiceLines(): Entity\Collection
    {
        return $this->get(Properties::salesInvoiceLines->name) ?? new Entity\Collection();
    }
