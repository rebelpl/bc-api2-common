...
class Record extends Entity
{
    ...
    public ?Carbon $employmentDate {
        set => $this->setAsDateTime('employmentDate', $value);
        get => $this->getAsDateTime('employmentDate');
    }

    public ?Carbon $terminationDate {
        set => $this->setAsDateTime('terminationDate', $value);
    ...
    public ?Carbon $birthDate {
        set => $this->setAsDateTime('birthDate', $value);
    ...
    public ?Entity\Collection $timeRegistrationEntries {
        get => $this->get('timeRegistrationEntries');
    }
