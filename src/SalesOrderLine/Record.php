...
class Record extends Entity
{
    ...
    function getShippedQuantity(): ?float
    {
        return $this->get('shippedQuantity');
    }

    function setShippedQuantity(?float $value): self
    {
        $this->set('shippedQuantity', $value);
        return $this;
    }
    ...
    function getShipQuantity(): ?float
    {
        return $this->get('shipQuantity');
    }

    function setShipQuantity(?float $value): self
    {
        $this->set('shipQuantity', $value);
        return $this;
    }
